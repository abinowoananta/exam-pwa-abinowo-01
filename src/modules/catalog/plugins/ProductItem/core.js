                    ...
                    <Show when={showAddToCart && !viewItemOnly}>
                        <Button
                            ...
                            className={classNames(
                                ...
                                'hover:shadow-[0_0_0_4px] hover:shadow-primary-300 !rounded-[8px]',
                            )}
                        >
                        ...
                        {isOos && (
                            <div className={classNames('absolute top-2 tablet:top-3 left-2 tablet:left-3 z-10')}>
                                <Badge
                                    ...
                                    className={
                                        classNames(
                                            '!bg-neutral-50 !text-neutral-400 !text-xs tablet:!text-sm',
                                        )
                                    }
                                />
                            </div>
                        ...
                        >
                            <Show when={showWishlist && !usedInWishlist}>
                                <Button
                                    ...
                                    onClick={() => handleFeed(props)}
                                    className={classNames(
                                        'swift-action-towishlist !p-[10px] !border-0 mr-2 opacity-80 hover:!opacity-100',
                                    )}
                                />
                            </Show>
                            <Show when={usedInWishlist}>
                                <Button
                                    ...
                                    onClick={() => handlingRemove()}
                                    className={classNames(
                                        'swift-action-toremove !p-[10px] !border-0 opacity-80 hover:!opacity-100',
                                    )}
                                />
                            </Show>
                            <Show when={showProductCompare}>
                                <Button
                                    ...
                                    onClick={() => handleSetCompareList(props?.id)}
                                    className={classNames(
                                        'swift-action-tocompare !p-[10px] !border-0 opacity-80',
                                        'hover:!shadow-none focus:!shadow-none hover:!opacity-100',
                                    )}
                                />
                            </Show>
