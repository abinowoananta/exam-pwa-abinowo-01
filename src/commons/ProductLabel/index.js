    ...
    return (
        <div className={cx('product-label', className)}>
            <Show when={IS_OOS}>
                <Badge
                    bold
                    className={cx('product-label-oos !bg-neutral-50 !text-neutral-400 uppercase mb-[6px]')}
            ...
            <Show when={!IS_OOS && config.enable && config.new.enable && showLabelNew}>
                <Badge
                    bold
                    success
                    className={cx('product-label-new uppercas !bg-green-50 !text-green-700', classNameBadge)}
            ...
            <Show when={!IS_OOS && config.enable && config.sale.enable && showSale}>
                <Badge
                    bold
                    danger
                    className={cx('product-label-sale uppercase !bg-red-50 !text-red-500', showLabelNew && 'mt-[4px]', classNameBadge)}
